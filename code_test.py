...
class SampleApp(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        for F in (StartPage, PageOne, PageTwo, PageThree, PageFour, PageFive,
                  ...
                  Page34, Page35, Page36, Page37, Page38, Page39, Page40):
...
class PageEleven(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.label = ttk.Label(self, text="", font=("Comic Sans MS", 25), background="#FFFFFF")
        self.label.place(x= 950, y = 200)
        ...
        self.canvas = tk.Canvas(self, width=200, height=20, background="#FFFFFF", highlightthickness=0)
        self.canvas.create_rectangle(0, 0, 200, 20, fill="#096612", outline="")
...
class PageTwo(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = ttk.Button(self, text="Vocabulary 詞彙",
                                     style="TButton",
                                     width=25,
                                     command=lambda: controller.show_frame(Page26))
...
class Page26(tk.Frame):
    def __init__(self, parent, controller):
        ...
        question_label = ttk.Label(self, text="書本用英語怎麼說?", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)

        # Button to navigate to the next page
        button_next = ttk.Button(self, text="Next 下一個",style = 'TButton',
                                command=lambda: controller.show_frame(Page27))
        button_next.pack()
        button_next.place(x=950, y=700, width=200, height=50)
    ...
    def run_code(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("書本用英語怎麼說?").get()
                ...
                # Record student's speech and recognize
                max_attempts = 1  # Adjusted to 1 attempt only
                for attempt in range(1, max_attempts + 1):
                    print("\nAttempt", attempt)
                    print("Please read the word aloud:")
                    ...
                    if speech_recognition_result.reason == speechsdk.ResultReason.RecognizedSpeech:
                        ...
                        if spoken_text.lower() == word.lower():
                            ...
                            # Incorrect recognition
                            print("Wrong!")
                            # Synthesize "Wrong, please try practice mode" in Chinese
                            synthesis_result = speech_synthesizer_cn.speak_text_async(
                                "錯誤，請使用練習模式進行練習。").get()
                            self.decrease_life()
                    elif speech_recognition_result.reason == speechsdk.ResultReason.NoMatch:
    ...
    def decrease_life(self):
        ...
        if self.lives <= 0:
            # If lives run out, display message box and reset lives
            messagebox.showinfo("No more lives", "No more lives, use practice mode to practice")
            self.lives = 5
            self.update_life_bar()

    def update_life_bar(self):
        # Update the life bar based on the remaining lives
        self.canvas.delete("life")
        fill_color = "#096612" if self.lives > 0 else "#e60909"
        self.canvas.create_rectangle(0, 0, self.lives * 40, 20, fill=fill_color, outline="", tags="life")


class Page27(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.configure(background="#FFFFFF")  # Set background color to white
        self.controller = controller
        ...
        question_label = ttk.Label(self, text="椅子 這個在 英文 怎麼說？", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
        ...
        # Button to navigate to the next page
        button_next = ttk.Button(self, text="Next 下一個",style = 'TButton', width = 15,
                                command=lambda: controller.show_frame(Page28))
        button_next.pack()
        button_next.place(x=950, y=700, width=200, height=50)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("椅子 這個在 英文 怎麼說?").get()
...
class Page28(tk.Frame):
    def __init__(self, parent, controller):
        ...
        #make changes later
        question_label = ttk.Label(self, text="醫生用英語怎麼說?", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)

        # Button to navigate to the next page
        button_next = ttk.Button(self, text="Next 下一個",style = 'TButton',
                                command=lambda: controller.show_frame(Page29))
        button_next.pack()
        button_next.place(x=950, y=700, width=200, height=50)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("醫生用英語怎麼說?").get()
...
class Page29(tk.Frame):
    def __init__(self, parent, controller):
        ...
        question_label = ttk.Label(self, text="公車這個在英語怎麼說？", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
    ...
    def run_code2(self):
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("公車這個在英語怎麼說？").get()
...
class Page30(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.configure(background="#FFD700")  # Set background color to white
        self.controller = controller
        ...
        question_label = ttk.Label(self, text="起床了用英語怎麼說?", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
        ...
        button_next = ttk.Button(self, text="Back 後退",style = 'TButton',
                                command=lambda: controller.show_frame(PageTwo))
        button_next.pack()
        button_next.place(x=20, y=700, width=200, height=50)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("起床了用英語怎麼說?").get()
...
class Page31(tk.Frame):
    def __init__(self, parent, controller):
        ...
        question_label = ttk.Label(self, text="洗澡用英語怎麼說？", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("洗澡用英語怎麼說？").get()
...
class Page32(tk.Frame):
    def __init__(self, parent, controller):
        ...
        question_label = ttk.Label(self, text="穿好衣服用英語怎麼說?", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("穿好衣服用英語怎麼說?").get()
...
class Page33(tk.Frame):
    def __init__(self, parent, controller):
        ...
        question_label = ttk.Label(self, text="吃早餐用英語怎麼說?", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("吃早餐用英語怎麼說?").get()
...
class Page34(tk.Frame):
    def __init__(self, parent, controller):
        ...
        question_label = ttk.Label(self, text="刷牙用英語怎麼說?", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("刷牙用英語怎麼說?").get()
...
class Page35(tk.Frame):
    def __init__(self, parent, controller):
        ...
        question_label = ttk.Label(self, text="去學校用英文怎麼說?", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
        
        # Button to navigate to the next page
        button_next = ttk.Button(self, text="Next 下一個", style = 'TButton',
                                command=lambda: controller.show_frame(Page36))
        button_next.place(x=950, y=700, width=200, height=50)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("去學校用英文怎麼說?").get()
...
class Page36(tk.Frame):
    def __init__(self, parent, controller):
        ...
        question_label = ttk.Label(self, text="吃午餐用英文怎麼說?", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
        # Button to navigate to the next page
        button_next = ttk.Button(self, text="Next 下一個", style = 'TButton',
                                command=lambda: controller.show_frame(Page37))
        button_next.place(x=950, y=700, width=200, height=50)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("吃午餐用英文怎麼說?").get()
...
class Page37(tk.Frame):
    def __init__(self, parent, controller):
        ...
        style.configure("TButton",
                        ...
                        font=("Comic Sans MS",20),
                        padding=[10,10,10,10])
        question_label = ttk.Label(self, text="回家用英語怎麼說?", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
        
        # Button to navigate to the next page
        button_next = ttk.Button(self, text="Next 下一個", style = 'TButton',
                                command=lambda: controller.show_frame(Page38))
        button_next.place(x=950, y=700, width=200, height=50)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("回家用英語怎麼說?").get()
...
class Page38(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        question_label = ttk.Label(self, text="吃晚餐用英語怎麼說?", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
        
        # Button to navigate to the next page
        button_next = ttk.Button(self, text="Next 下一個", style = 'TButton',
                                command=lambda: controller.show_frame(Page39))
        button_next.place(x=950, y=700, width=200, height=50)
        ...
        # Run Code Button
        button_run_code = ttk.Button(self,command=self.run_code2)
        image = tk.PhotoImage(file="mc.png")  # Specify the path to your image file
        button_run_code.config(image=image)
        button_run_code.image = image  # Keep a reference to avoid garbage collection
        button_run_code.pack()
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("吃晚餐用英語怎麼說?").get()
...
class Page39(tk.Frame):
    def __init__(self, parent, controller):
        ...
        question_label = ttk.Label(self, text="我的作業用英文怎麼說？", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
        # Button to navigate to the next page
        button_next = ttk.Button(self, text="Next 下一個", style = 'TButton',
                                command=lambda: controller.show_frame(Page40))
        button_next.place(x=950, y=700, width=200, height=50)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("我的作業用英文怎麼說？").get()
...
class Page40(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        question_label = ttk.Label(self, text="去睡覺了用英語怎麼說?", font=("Times New Roman", 25), background="#FFFFFF")
        question_label.pack(pady=20, padx=20)
    ...
    def run_code2(self):
        ...
        def tts_prompt_vocabulary(vocabulary):
            ...
            for word in vocabulary:
                ...
                # Synthesize and play the speech for word
                synthesis_result = speech_synthesizer_en.speak_text_async("去睡覺了用英語怎麼說?").get()
...
class PageFour(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="1", font=("Comic Sans MS", 25), background="#FFFFFF")
        label.pack(pady=10, padx=10)
        ...
        #make button_page_two have a light blue (color code) background
        button_page_two = ttk.Button(self, text="Next 下一個", style="TButton", width = 25,
                                    command=lambda: controller.show_frame(PageFive))
        button_page_two.pack(side="bottom", pady=10)
        button_page_two.place(x=950, y=700, width = 200, height = 50)
        
        button_page_three = ttk.Button(self, text="Back 後退",style = "TButton", width = 25,
                                      command=lambda: controller.show_frame(PageThree))
        button_page_three.pack(side="bottom", pady=10)
        button_page_three.place(x=10, y=700, width=200, height=50)
        
        self.create_image_buttons()  # Create image buttons

        # Label to display the clicked button
        self.clicked_button_label = tk.Label(self, text="", font=("Comic Sans MS", 18))
        self.clicked_button_label.pack()

        label = tk.Label(self, text="Car", font=("Comic Sans MS", 25), background="#FFFFFF")
    ...
    def button_click(self, button_name, image):
        ...
        if button_name == "Button 1":
            ...
            x = 140  # X coordinate for new image
            y = 50  # Y coordinate for new image

        elif button_name == "Button 2":
            new_image_path = "correct.jpg"
            x = 440  # X coordinate for new image
            y = 50  # Y coordinate for new image

        elif button_name == "Button 3":
            new_image_path = "wrong.jpg"
            x = 740  # X coordinate for new image
            y = 50  # Y coordinate for new image
...
class PageFive(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button_page_three = tk.Button(self, text="Next 下一個", font=("Comic Sans MS", 15), width=10, height=3, background="light blue",
                                      command=lambda: controller.show_frame(PageSix))
        button_page_three.pack(side="bottom", pady=10)
        button_page_three.place(x=950, y=700, width = 200, height = 50)
        
        button_page_three = tk.Button(self, text="Back 後退", font=("Comic Sans MS", 15), width=10, height=3, background="light blue",
                                      command=lambda: controller.show_frame(PageFour))
        button_page_three.pack(side="bottom", pady=10)
        button_page_three.place(x=10, y=700, width = 200, height = 50)
        ...
        label = tk.Label(self, text="Banana", font=("Comic Sans MS", 25), background="#FFFFFF")
        label.pack(side="bottom", pady=20, padx=20)

    def create_image_buttons(self):
    # Create Button 1
        image_path_1 = "banana.jpg"
        image_1 = ImageTk.PhotoImage(file=image_path_1)
        button1 = tk.Button(self, text="", width=320, height=250, image=image_1, compound=tk.CENTER,
        ...
        # Create Button 2
        image_path_2 = "apple.png"
        image_2 = ImageTk.PhotoImage(file=image_path_2)
        button2 = tk.Button(self, text="", width=320, height=250, image=image_2, compound=tk.LEFT,
                            background="white", borderwidth=0, highlightthickness=0,
                            command=lambda: self.button_click("Button 2", image_2))
        button2.pack()
        button2.place(x=440, y=275)
        ...
        # Create Button 3
        image_path_3 = "orange.jpg"
        image_3 = ImageTk.PhotoImage(file=image_path_3)
        button3 = tk.Button(self, text="", width=320, height=250, image=image_3, compound=tk.RIGHT,
                            background="white", borderwidth=0, highlightthickness=0,
                            command=lambda: self.button_click("Button 3", image_3))
        button3.pack()
        button3.place(x=740, y=275)
...
class PageSix(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Button to go to PageTwo
        button = tk.Button(self, text="Next 下一個", font=("Comic Sans MS", 15), width=10, height=3, background="light blue",
                                      command=lambda: controller.show_frame(PageSeven))
        button.pack(side="bottom", pady=10)
        button.place(x=950, y=700, width = 200, height = 50)
        
        button = tk.Button(self, text="Back 後退", font=("Comic Sans MS", 15), width=10, height=3, background="light blue",
                                      command=lambda: controller.show_frame(PageFour))
        button.pack(side="bottom", pady=10)
        button.place(x=10, y=700, width = 200, height = 50)
        self.create_image_buttons()  # Create image buttons
...
class PageNine(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Button to go to PageTwo
        button = tk.Button(self, text="Finish 下一個", font=("Comic Sans MS", 15), width=10, height=3, background="light blue",
                                      command=lambda: controller.show_frame(PageThree))
        button.pack(side="bottom", pady=10)
        button.place(x=950, y=700, width = 200, height = 50)
